...
export const makeDirectoryModel: Immutable.RecordFactory<DirectoryModelRecordProps> = Immutable.Record(
  {
    type: "directory",
    items: Immutable.List()
  }
);
export type DirectoryModelRecord = Immutable.RecordOf<DirectoryModelRecordProps>;
...
export const makeDirectoryContentRecord: Immutable.RecordFactory<DirectoryContentRecordProps> = Immutable.Record(
  {
    mimetype: null,
    type: "directory",
    created: null,
...
export type DirectoryContentRecord = Immutable.RecordOf<DirectoryContentRecordProps>;
